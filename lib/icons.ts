// Curated icon set for page types
// Each icon is an SVG path string (24x24 viewBox)
...
export const availableIcons: IconDefinition[] = [
  ...
  },
  {
    name: "layout",
    label: "Layout",
    path: "M19 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2z M3 9h18 M9 21V9",
  },
  {
    name: "book",
    label: "Book",
...
export function getDefaultIcon(): IconDefinition {
  return availableIcons[0]; // "file"
}
